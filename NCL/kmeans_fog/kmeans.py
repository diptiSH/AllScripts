...
fl=open("Write_sil_3levCirc3levCirc3levCirc","w")
...
for n_clusters in range_n_clusters:
    ...
    clusterer = KMeans(n_clusters=n_clusters, max_iter=3000, random_state=1)
